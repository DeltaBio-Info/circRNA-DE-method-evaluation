# =============================================================================
# CircRNA Detection and Quantification Pipeline
# =============================================================================
# Purpose:
#     Runs a complete circRNA detection workflow from raw paired-end FASTQ files.
#     The pipeline performs read cleaning, quality control, genome alignment,
#     circRNA detection with CIRI3 and CIRCexplorer2, CE2 quantification, and
#     final BSJ/FSJ count matrix generation.
#
# Inputs:
#     project_dir          :            Main project directory.
#     scripts_dir          :            Directory containing helper pipeline scripts.
#     ref_fa               :            Reference genome FASTA file.
#     ref_gtf              :            Reference genome GTF annotation file.
#     flat_ref             :            GenePred / flattened annotation reference for circ_quant.
#     hisat_idx            :            HISAT2 genome index prefix.
#     threads              :            Number of CPU threads to use.
#
# Expected Project Structure:
#     project_dir/
#     raw/                            	Raw paired-end FASTQ files.
#     cleaned/                        	Cleaned FASTQ files generated by fastp.
#     FASTP_reports/                  	fastp reports.
#     aligned/                        	SAM/BAM alignment outputs.
#     
#	  circRNA_outs/
#     CIRI3/                        	CIRI3 circRNA results and matrices.
#     CE2/                          	CIRCexplorer2 outputs and quantification.
#
# Outputs:
#     cleaned/                          Cleaned FASTQ files.
#     FASTP_reports/                    fastp HTML/JSON reports.
#     aligned/                          BWA and HISAT2 BAM/SAM alignment files.
#     circRNA_outs/CIRI3/               CIRI3 .ciri files and BSJ/FSJ matrices.
#     circRNA_outs/CE2/                 CE2 parsed, annotated, and quantified outputs.
#
#     Helper scripts:
#       fastp.py
#       fastqc.py
...
# Function: run_cmd
# =============================================================================
# Runs a shell command or command list while streaming standard output and
# standard error directly to the terminal.
#
# Parameters:
#     cmd                  :            Command to execute. Can be a list of
#                                       command arguments or a shell command.
#
#
# Returns:
#        None              :            Prints command output to the terminal.
# =============================================================================
...
# Function: log
# =============================================================================
# Prints timestamped pipeline messages to track pipeline progress.
#
# Parameters:
...
#
# Returns:
#        None              :            Prints the timestamped message.
# =============================================================================
def log(msg):
